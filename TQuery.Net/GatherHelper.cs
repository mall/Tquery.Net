...
namespace TQuery.Net
{
    public class GatherHelper
    {
        ...
        {
            if (string.IsNullOrEmpty(Code)) return new List<KeyValuePair<int, string>>();
        ...
        {
            if (string.IsNullOrEmpty(html)) return new List<KeyValuePair<string, string>>();
        ...
        /// <param name="html">原HTML</param>
        /// <returns></returns>
        public static IList<string> FetchImg(string html)
        {
